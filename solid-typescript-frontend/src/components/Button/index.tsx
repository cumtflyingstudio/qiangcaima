...
const Button: Component<IButton> = (props) => {
  ...
  setTimeout(() => {
    ...
    const randomRange = (min, max) => (min + Math.random() * (max - min)) | 0;
    ...
    // add elements to arrays to b e drawn
    const initBurst = () => {
  ...
  return (
    ...
    >
      <button
        ...
        class="ready"
        onClick={async () => {
          await window.clickButton();
          props.onClick();
        }}
      >
        <div class="message submitMessage">
          <svg class="animate-bounce" style="height:30px;width:30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 12.2">
            <polyline stroke="currentColor" points="2,7.1 6.5,11.1 11,7.1 " />
            <line stroke="currentColor" x1="6.5" y1="1.2" x2="6.5" y2="10.3" />
          </svg>
          <span class="button-text">点击抢菜</span>
        </div>
        ...
        <div class="message successMessage">
          ...
          <span style="height:30px;width:30px" class="button-text">
            抢菜成功
          </span>
        </div>
        <div class="message errorMessage">
          <span class="button-text text-red-500">抢菜失败</span>
        </div>
      </button>
